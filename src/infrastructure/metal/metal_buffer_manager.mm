...
std::vector<Color3> MetalBufferManager::dispatch_ray_trace(const GPUCamera& camera,
    ...
    // Scene counts: shape_count, material_count, light_count, bvh_node_count (0 = no BVH)
    uint32_t scene_counts[4] = {
        ...
        0  // no BVH in this overload
    };

    // Empty BVH buffer (Metal requires a valid buffer for all bound indices)
